...
The script also includes a flush feature that logs idle input after 3 seconds and displays a branded ASCII banner on launch. All keystrokes are saved to v1rtu3_trace.txt and v_kat_outbox.txt for review or cyber forensic purposes.
